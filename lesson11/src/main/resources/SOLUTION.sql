...
-- 1. Update table Subject.
-- Update grade 5 for subject name ‘End of Suburbia: Oil Depletion and the Collapse of the American Dream’
...
UPDATE Payment SET amount = 8, student_id = 2 WHERE payment_date > 2021-01-01 AND type_id = 2;
